...
export const groupSlice = createSlice({
  ...
  reducers: {
    ...
    addValueTopic: (state, action: PayloadAction<string>) => {
      state.valueTopics.push(action.payload)
    },
...
export const { addValueTopic, addValueQuestion, updateGroup } = groupSlice.actions

export const selectGroupId = (state: RootState) => state.group.id
export const selectValueTopics = (state: RootState) => state.group.valueTopics
